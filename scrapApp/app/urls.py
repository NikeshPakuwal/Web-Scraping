...
urlpatterns = [
    ...
    path('admin/user/<int:id>/edit/', adminpanelView.AdminUserEdit, name = 'user_view'),
    path('admin/user/<int:id>/view/', adminpanelView.AdimUserView, name="user_display"),
    ...
    path('admin/google/delete/<int:pk>', GoogleLinksDelete, name='googlelink_delete'),
    ...
    path('admin/scrap/delete/<int:pk>', ScrapListDelete, name='scrap_list_delete'),
    ...
    path('admin/scrap/json/delete/<int:pk>', JsonListDelete, name='json_delete'),
